...
const hotelRoom = {
  ...
  fields: [
    ...
    defineField({
      ...
      title: "Price",
      type: "number",
      validation: (Rule) => Rule.required().min(1).error("Minimum price is 1"),
    }),
    defineField({
      name: "discount",
      title: "Discount",
    ...
    defineField({
      ...
      validation: (Rule) => Rule.required(),
      initialValue:
        "Check-in time is 12:00 PM, checkout time is 11:00 AM. If you leave behind any items, please contact the receptionist.",
    }),
    defineField({
      name: "dimension",
      title: "Dimension",
