...
const HotelPhotoGallery: FC<{ photos: ImageType[] }> = ({ photos }) => {
  ...
  // TODO: Change this to ideally atleast 5 or calculate on the basis of screen size
  ...
  return (
    <div className="container mx-auto">
      <div className="grid md:grid-cols-2 relative gap-5 px-3">
        ...
        <div className="hidden md:grid grid-cols-2 h-fall gap-5">
          ...
          {remainingPhotosCount > 0 && (
            ...
            >
              <Image
                ...
                className="img"
              />
              <div className="absolute cursor-pointer text-white inset-0 flex justify-center bg-[rgba(0,0,0,0.5)] items-center text-4xl">
        ...
        {showModal && (
          <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opactiy-90 z-[55]">
            <div className="h-[75vh] w-[320px] md:[700px] relative">
              <Image
                src={photos[currentPhotoIndex].url}
                alt={`Room Photo ${currentPhotoIndex + 1}`}
                width={150}
